  ...
  return (
    <div>
      ...
      <Panel className="space-y-5">
        <div>
          <h2 className="text-12 font-medium uppercase text-ink-tertiary">
            {t('User')}
          </h2>
          ...
          <p className="mt-1.25 text-14 text-ink-secondary capitalize">
        ...
        <div className="border-t border-line-subtle pt-5">
          ...
          {session.user.role === 'root' || session.user.role === 'admin' ? (
            <p className="mt-1.25 text-pretty text-13 text-ink-tertiary">
              {t(
